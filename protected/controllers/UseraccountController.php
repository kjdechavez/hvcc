...
class UseraccountController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Useraccount']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->useraccount_id));
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Useraccount']))
		{
			...
			if($_POST['oldpassword']!=$_POST['Useraccount']['password']){
				$model->password = SecurityHelper::ecrypt($_POST['Useraccount']['password']);	
			}
